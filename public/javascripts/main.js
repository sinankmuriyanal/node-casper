...
( function () {
    ...
    Riode.defaults = {
        ...
        templateCartAddedAlert: '<div class="alert alert-simple alert-btn cart-added-alert">' +
            ...
            '<button type="button" class="btn btn-link btn-close"><i class="fa fa-times"></i></button>' +
            '</div>',
        zoomImage: {
            responsive: true,
        ...
        function initWishlistAction ( e ) {
            ...
            setTimeout( function () {
                $this
                    ...
                    .html( '<i class="fa fa-heart-full"></i> Browse wishlist' )
                    .addClass( 'added' )
    ...
    Riode.Shop = {
                ...
                .on( 'mousedown', '.select-menu', function ( e ) {
                    ...
                    if ( $selectMenu.is( $target.parent() ) ) {
                        ...
                        if ( $target.parent().hasClass( 'active' ) ) { // add select-item, and show
                            $( '.select-items' ).show();
                            $( '<a href="#" class="select-item">' + $target.text() + '<i class="fa fa-times"></i></a>' )
        ...
        initWishlistButton: function ( selector ) {
            Riode.$body.on( 'click', selector, function ( e ) {
                ...
                setTimeout( function () {
                    $this.removeClass( 'load-more-overlay loading' ).find( 'i' ).toggleClass( 'fa fa-heart' )
                        .toggleClass( 'fa fa-heart-full' );
